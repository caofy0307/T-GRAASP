"""
Spectral Graph Wavelet Transform Convolution Layer
==================================================
Implementation of spectral graph wavelet transform (SGWT) convolution for graphs.
...
class SGWTConv(MessagePassing):
    """
    Spectral Graph Wavelet Transform Convolution.
    
    Implements graph convolution using spectral graph wavelets based on
    Chebyshev polynomial approximation of the graph Laplacian.
    
    Args:
        in_channels (int): Number of input features
        out_channels (int): Number of output features
        K (int): Order of Chebyshev polynomial (filter size)
        normalization (str, optional): Graph Laplacian normalization ('sym', 'rw', or None)
