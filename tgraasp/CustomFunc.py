"""
TGRAASP Custom Functions Module
================================
Custom mathematical and graph utility functions for spatial transcriptomics analysis.

Main Functions:
- cov: Covariance matrix computation
- dropout_edge: Edge dropout for graph regularization
- onehot_to_label: Convert one-hot to label format
- scale: Feature scaling
- matrix_regulize: Matrix regularization for stability
- graph_cov: Graph-based covariance computation
- NNeighbors: Nearest neighbor graph construction
"""
...
from torch_geometric.utils import (
    remove_self_loops, to_dense_batch, to_dense_adj, 
